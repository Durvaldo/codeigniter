        ...
        <div class="container">
            <table class="ex2">
                ...
                <tr>
                    ...
                    <td class="ex2">Bruno mendonça</td>
                    <td class="ex2">Intocáveis</td>
                    <td class="ex2">Amnésia</td>
                    <td class="ex2">Gladiador</td>
                </tr>
                <tr>
                    <td class="ex2">Daniel Lourenço</td>
        ...
        <div class="container">
            <table class="ex3">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="media" scope="row" colspan="4">Média de exatas</th>
                        <td class="nota">0.0</td>
                    </tr>
                    <tr>
